    ...
    <div className="min-h-screen bg-[#F8F9FA] flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-md space-y-8 bg-white p-12 rounded-[3rem] shadow-[0_20px_50px_rgba(0,0,0,0.05)] border border-gray-100 relative z-10">
        <div className="text-center">
          ...
          <p className="text-[9px] text-gray-400 uppercase tracking-[0.3em] mt-2">Authorized Access Only</p>
        </div>

        <div className="space-y-6">
          <div className="space-y-2">
            <label className="text-[9px] font-black text-[#1A1A1A] uppercase tracking-widest ml-1">Username</label>
            <div className="relative">
              <User className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-300" size={18} />
              <input 
                type="text" 
                className="w-full bg-gray-50 border border-gray-100 rounded-2xl py-4 pl-12 pr-4 text-[#1A1A1A] focus:border-[#1A1A1A] outline-none transition-all placeholder:text-gray-300" 
          ...
          <div className="space-y-2">
            <label className="text-[9px] font-black text-[#1A1A1A] uppercase tracking-widest ml-1">Password</label>
            <div className="relative">
          ...
          <button 
            onClick={onLogin}
            className="w-full bg-[#1A1A1A] text-white py-5 rounded-2xl text-[11px] font-black uppercase tracking-[0.2em] shadow-xl hover:bg-[#333] transition-all transform active:scale-[0.98]"
          >
            Authenticate
          </button>
        </div>
