...
const Login = ({ username, password, setUsername, setPassword, onLogin, onBack }) => {
  return (
    <div className="min-h-screen bg-[#1A120B] flex items-center justify-center p-6 relative">
      {/* Back Button */}
      <button 
        onClick={onBack}
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-white/5 border border-white/10 rounded-2xl py-4 pl-12 pr-4 text-white focus:border-[#8D775F] outline-none transition-all"
